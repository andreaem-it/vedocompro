...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ShopProductsRepository")
 */
class ShopProducts
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\ShopCategories", inversedBy="shopProducts")
     */
    private $category;
